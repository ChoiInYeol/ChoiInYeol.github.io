...
media_subpath: /assets/img/images_240202/
---
...
![좋코딩 시즌1을 보셨는진 모르겠지만, 현실에 가깝습니다.](dev_jocoding.png)
...
![인프런의 부트캠프](dev_inf.png)

![패스트캠퍼스의 DevOps 강의. 25만원에 판매](dev_fastcampus.png)
...
![Coursera의 무료 Devops 강의](dev_coursera.png)

![freecodecamp.org의 무료 강의 (Youtube)](dev_youtube_freecodecamp.png)
...
3. **[Visual Studio Code 로 다루는 Git](https://www.youtube.com/playlist?list=PLuHgQVnccGMAQvSVKdXFiOo51HUD8iQQm)**
...
- [실전 알고리즘 강좌 (Algorithm Programming Tutorial)](https://www.youtube.com/playlist?list=PLRx0vPvlEmdDHxCvAQS1_6XV4deOwfVrz)
